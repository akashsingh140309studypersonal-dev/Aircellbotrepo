...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [
        [InlineKeyboardButton("📚 Study Materials", callback_data="btn_materials_from_start"), InlineKeyboardButton("🏆 Leaderboard", callback_data="btn_top_from_start")],
        [InlineKeyboardButton("👤 My Profile", callback_data="btn_profile_from_start"), InlineKeyboardButton("❓ Help Menu", callback_data="btn_help_from_start")]
    ]
...
# Buttons Quick Callback Router (Dynamic Navigation Handler)
async def start_buttons_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "materials":
        await materials_list(update, context, back_target=source)
    elif action == "top":
        await top_leaderboard(update, context, back_target=source)
    elif action == "profile":
        await view_profile(update, context, back_target=source)
    elif action == "help":
        await help_command(update, context)

async def users_list(update: Update, context: ContextTypes.DEFAULT_TYPE, back_target="help"):
    ...
    cb_back = f"btn_{back_target}" if not back_target.startswith("btn_") else back_target
    markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔙 Back", callback_data=cb_back)]])
...
async def post_channel_manager(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons.append([InlineKeyboardButton("🔙 Back to Help Menu", callback_data="btn_help")])
...
async def view_profile(update: Update, context: ContextTypes.DEFAULT_TYPE, target_uid=None, target_uname=None, back_target="help"):
    if target_uname:
    ...
    if update.callback_query:
        await update.callback_query.edit_message_text(profile_text, reply_markup=markup, parse_mode="Markdown")
    else:
...
async def top_leaderboard(update: Update, context: ContextTypes.DEFAULT_TYPE, back_target="help"):
...
async def materials_list(update: Update, context: ContextTypes.DEFAULT_TYPE, back_target="help"):
