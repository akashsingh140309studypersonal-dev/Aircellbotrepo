...
async def bridge_cmd(event):
    ...
    failure_reasons = {
        ...
        "Admin Approval Needed (Request Sent)": 0,
    ...
    try:
        ...
        # Fetch members without force-join requirement (Using Message History scan fallback)
        ...
        for user in members:
            ...
            try:
                ...
                failed += 1
                failure_reasons["Admin Approval Needed (Request Sent)"] += 1
